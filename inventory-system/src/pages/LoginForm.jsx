    ...
    return (
        ...
        <div className="flex min-h-full flex-col justify-center px- py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                <img src={LogiscoolLogo} alt="Your Company" className=" mx-auto h-15 w-auto mb-5" />
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form action="#" method="POST" className="space-y-6">
                    <div>
                        ...
                        <div className="mt-2">
                            <input id="email" placeholder="Email " type="email" name="email" required autocomplete="email" 
                            className="border border-gray-300  block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                        </div>
                    </div>
                    ...
                    <div className="mt-2 relative">
                        ...
                        <input
                            ...
                            className="border border-gray-300 block w-full rounded-md bg-white/5 px-3 py-1.5 pr-10 text-white placeholder:text-gray-500 outline-1 -outline-offset-1 outline-white/10 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"
                        />
